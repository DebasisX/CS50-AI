...
knowledge0 = And(Not(Implication(AKnave, AKnight)))

# Puzzle 1
# A says "We are both knaves."
# B says nothing.
knowledge1 = And(Not(AKnight), Or(AKnight, AKnave), Or(BKnight, BKnave),
                 Not(BKnave))

# Puzzle 2
# A says "We are the same kind."
# B says "We are of different kinds."
knowledge2 = And(Implication(AKnight, BKnight), Implication(BKnight, AKnave),
